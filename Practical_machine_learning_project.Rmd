...
# Data source
The data for this project come originally from this source: http://groupware.les.inf.puc-rio.br/har. [@velloso2013] 
...
oos_err
```
The estimated accuracy of the model is 99.73% and the estimated out-of-sample error based on our fitted model applied to the test dataset is 0.27%.
